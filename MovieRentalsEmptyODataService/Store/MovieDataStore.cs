        ...
        public static readonly List<Movie> Movies = new List<Movie>
        {
            ...
            new Movie
            {
                ...
                Cast =
                {
                    ...
                    new Actor { Id = 4, FirstName = "Al", LastName = "Pacino", Gender = Gender.Male, DateOfBirth = new DateTimeOffset(new DateTime(1940, 4, 25)) }
                }
            },
            new Movie
            {
                ...
                Cast =
                {
                    ...
                    new Actor { Id = 6, FirstName = "Heath", LastName = "Ledger", Gender = Gender.Male, DateOfBirth = new DateTimeOffset(new DateTime(1979, 4, 4)) }
                }
            },
            new Movie
            {
                ...
                Cast =
                {
                    ...
                    new Actor { Id = 8, FirstName = "John", LastName = "Fielder", Gender = Gender.Male, DateOfBirth = new DateTimeOffset(new DateTime(1925, 2, 3)) }
                }
            },
            new Movie
            {
                ...
                Cast =
                {
                    ...
                    new Actor { Id = 10, FirstName = "John", LastName = "Fielder", Gender = Gender.Male, DateOfBirth = new DateTimeOffset(new DateTime(1970, 4, 29)) }
                }
